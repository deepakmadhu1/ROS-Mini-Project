...
def generate_launch_description():
    ...
    world_path = os.path.join(get_package_share_directory('examtask'), 'worlds', world_file_name)
    ...
    xacro_file = os.path.join(get_package_share_directory('examtask'),
                              'urdf',
                              'examtask.urdf.xacro')
    rviz_file = os.path.join(get_package_share_directory('examtask'),
                              'rviz',
                              'examtask.rviz')                             
